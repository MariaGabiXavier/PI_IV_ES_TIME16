...
public class Parceiro {
    ...
    public void receba(Comunicado x) throws Exception {
        try {
            if (x instanceof RespostaDeChatbot) {
                RespostaDeChatbot r = (RespostaDeChatbot) x;
                this.transmissor.writeUTF("RESP|" + r.getResposta());
            } else if (x instanceof PedidoDePergunta) {
                PedidoDePergunta p = (PedidoDePergunta) x;
                this.transmissor.writeUTF("PED|" + p.getOpcao());
            } else if (x instanceof PedidoParaSair) {
                this.transmissor.writeUTF("SAI|");
            } else if (x instanceof ComunicadoDeDesligamento) {
